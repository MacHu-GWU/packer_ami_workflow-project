# -*- coding: utf-8 -*-
#
# packer_ami_workflow documentation build configuration file, created by
...
import packer_ami_workflow as package
...
# Add data for Jinja2
try:
    from packer_ami_workflow.docs import doc_data
except:
    doc_data = dict()
