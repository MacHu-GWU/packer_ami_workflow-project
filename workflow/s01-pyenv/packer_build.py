...
ws = acore_ami.Workspace(name="aws_ubuntu", dir_root=dir_here)
...
#                 "and python3.11, virtualenv, poetry, awscli, boto3, boto_session_manager, s3pathlib, fire, rich pre-installed"
#             ),
#         },
#     )
